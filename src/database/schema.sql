-- =============================================================================
-- CARECONNECT RELATIONAL DATABASE SCHEMA FOUNDATION (PostgreSQL DDL)
-- Version: 1.0 (Phase 1)
-- =============================================================================
...
CREATE INDEX idx_sessions_patient ON clinical_sessions(patient_id);
CREATE INDEX idx_sessions_doctor ON clinical_sessions(doctor_id);
CREATE INDEX idx_responses_session ON history_responses(session_id);
CREATE INDEX idx_documents_session ON medical_documents(session_id);
CREATE INDEX idx_redflags_session ON red_flags(session_id);
